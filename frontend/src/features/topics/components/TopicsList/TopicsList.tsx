import { ChevronRight, MessageCircleCode, RefreshCcw, Tag } from "lucide-react";
          ...
          <div className="flex items-center w-full flex-col">
            <div className="w-full max-w-4xl ">
              <div className="flex justify-between items-center w-full px-2">
                <div>
                  <h1 className="text-lg sm:text-2xl bg-white max-w-max px-3 mt-2 sm:px-4 sm:py-1 rounded-xl border border-gray-200">
                    Your Topics
                  </h1>
