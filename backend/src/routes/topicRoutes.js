...
const { createTopic, deleteTopic, getUserTopics, getTopic } = require('../controllers/topicController');
...
router
   ...
   .get('/:profileSlug/:topicId', validateTopicId, validateRequest, getTopic)
